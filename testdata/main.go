...
const (
	netConfigPath     = "${GOPATH}/src/github.com/dovetail-lab/fabric-samples/testdata/config_min.yaml"
	entityMatcherPath = "${GOPATH}/src/github.com/dovetail-lab/fabric-samples/testdata/local_entity_matchers.yaml"
	user              = "User1"
	org               = "org1"
	channelID         = "mychannel"
